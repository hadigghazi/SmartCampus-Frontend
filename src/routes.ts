...
const CourseEvaluation = lazy(() => import('./pages/Student/CourseEvaluation/CourseEvaluation'));
...
const BusRoutes = lazy(() => import('./pages/Admin/BuseRoutes/BusRoutes'));
const BusRegistrations = lazy(() => import('./pages/Admin/BusRegistrations/BusRegistrations'));
...
const routes: CustomRouteProps[] = [
  ...
  },
  {
    ...
    component: CoursesRegistrationDetails,
  },
  {
  ...
  {
    path: '/instructor-channels/:id',
    component: InstructorChannel,
  },
  {
