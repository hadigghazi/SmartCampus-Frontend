...
import { facultiesCampusesApi } from './features/api/facultiesCampusesApi';
...
export const store = configureStore({
  reducer: {
    ...
    [facultiesCampusesApi.reducerPath]: facultiesCampusesApi.reducer,
    auth: authReducer,
  },
  ...
  .concat(facultiesCampusesApi.middleware)
});
